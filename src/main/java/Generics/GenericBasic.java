...
/*
Generics -> Generics are a programming feature that let you write type-safe and reusable code.
         -> Generics allows type perameters in classes, interfaces, constructor and methods;
...
public class GenericBasic {
    public static void main(String[] args) {
        ...
        // Creating an ArrayList without generic property:
...
//        int b = (int)list.get(1); // ⭐Its a ClassCastException. ⭐ //It is not possible bcz it's a String.
        String b = (String)list.get(1); // Correct
        
        
        // Making an Generic ArrayList:
        ArrayList<String> list1 = new ArrayList<>();
        
//        list1.add(7); -> Wrong, As it is String type. So it is filtered by compilar 
//                      -> CompileTime Error for time safety
